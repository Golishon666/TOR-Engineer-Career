    ...
    internal sealed class EngineerCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializeKeyStones()
        {
            _engineerRoot.Initialize(CareerID,
                "Open Fire! orders a brutal gunline volley. While active, the Engineer gains ranged physical damage and reload speed.",
                null,
                true,
                ChoiceType.Keystone,
                CombineMutations(
            ...
            Keystone("PowderDrill",
                "Open Fire! lasts longer and grants stronger reload speed.",
                CombineMutations(
                    MutateAbilityFloat(nameof(AbilityTemplate.Duration), 5f),
                    MutateStatusAdd("let_them_have_it_melee_rls", 0.10f)));

            Keystone("FieldTesting",
                "Open Fire! also grants ranged physical resistance.",
            ...
            Keystone("Ballistics",
                "Open Fire! grants stronger ranged damage and reload speed.",
                CombineMutations(
                    MutateStatusAdd("let_them_have_it_range_dmg", 0.10f),
                    MutateStatusAdd("let_them_have_it_melee_rls", 0.10f)));
            ...
            Keystone("RicochetTactics",
                "During Open Fire!, firearm hits ricochet into a nearby enemy.",
                CombineMutations(
                    MutateAbilityFloat(nameof(AbilityTemplate.Duration), 5f),
                    MutateTriggeredEffectFloat("apply_let_them_have_it", nameof(TriggeredEffectTemplate.Radius), 2f)));
        }
        ...
        protected override void InitializePassives()
        {
            ...
            Passive("FieldTesting", 3, "+20% inventory capacity for ammunition and tools.", new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.InventoryCapacity, true));
            ...
            Passive("ExplosiveRounds", 2, "+10% personal Fire damage.", new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Fire, 10), AttackTypeMask.Ranged));
            ...
            Passive("SuppressionFire", 3, "+10% personal ranged physical damage.", GunpowderDamage(10));
            ...
            Passive("Ballistics", 1, "+6 extra ammo per ammunition pouch.", Ammo());
            Passive("Ballistics", 2, "+20% personal ranged armor penetration.", new CareerChoiceObject.PassiveEffect(-20, PassiveEffectType.ArmorPenetration, AttackTypeMask.Ranged));
            Passive("Ballistics", 3, "+10% personal gunpowder ranged physical damage.", GunpowderDamage(10));
            Passive("Ballistics", 4, "Ranged troops in your party gain +35 Gunpowder skill.", new CareerChoiceObject.PassiveEffect(35, new List<string> { nameof(TORSkills.GunPowder) }, IsRangedTroop));
            ...
            Passive("RicochetTactics", 4, "+15% ranged physical resistance for ranged troops.", TroopRangedResistance(15));
        }
        ...
        private static List<CareerChoiceObject.MutationObject> RenameOpenFire()
        {
            return new List<CareerChoiceObject.MutationObject>
            {
                ...
                new()
                {
                    ...
                    MutationType = OperationType.Replace,
                    PropertyValue = (choice, originalValue, agent) => "Order a disciplined volley. While Open Fire! is active, the Engineer holds the line and gains ranged physical damage and reload speed. Career talents can extend the order, add ranged protection, explosive rounds, piercing shots and ricochets."
                }
            };
        }
